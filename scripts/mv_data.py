...
metrics = ['acc', 'f1', 'auc', 'cls_mse']
metrics_map = {'acc': 'acc', 'auc': 'auc', 'f1': 'f1', "make_scorer(accuracy_score)": 'acc', 'cls_mse': 'cls_mse'}
if task == 'rgs':
    metrics = ['mse', 'r2', 'mae']
    metrics_map = {
...
meta_res = '/root/mindware/scripts/data_cls/data/cls_mse'
if task == 'rgs':
