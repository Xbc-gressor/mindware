...
OUTPUT_FILE = 'results_leaderboard.txt'
NUM_THREADS = "1"
...
for dataset in chosen_datasets:
    ...
    predictor = TabularPredictor.load("AutogluonModels/ag-20241224_151438")
    ...
    with open(OUTPUT_FILE, 'a+') as f:
        f.write(f'leaderboard:{dataset},{leader_info.to_string(index=False)}\n')
