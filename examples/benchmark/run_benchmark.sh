...
for i in 4; do
    ...
    TASKS+=("python cls_benchmark.py --refit --Opt cashfe --optimizer block_1 --n_algorithm 6 --n_preprocessor 6 --time_limit 7200 --job_idx $i --output_dir ./refit_data --output_file res_refit_data.txt")
