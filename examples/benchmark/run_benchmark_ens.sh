...
#     TASKS+=("python cls_benchmark.py --time_limit 1 --refit full --job_idx $i --Opt ens --optimizer block_1 --output_dir ./res_ensopt_data_maxk --output_file res_ensopt_data_maxk.txt --stats_path ${cls_fil[$i]}")
#     TASKS+=("python rgs_benchmark.py --time_limit 1 --refit full --job_idx $i --Opt ens --optimizer block_1 --output_dir ./res_ensopt_data_maxk --output_file res_ensopt_data_maxk.txt --stats_path ${rgs_fil[$i]}")
# done
