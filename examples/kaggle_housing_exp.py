...
if __name__ == '__main__':
    ...
    result_hpo.to_csv(os.path.join(data_dir,
                               f'SMAC{estimator_id}{x_encode}{label_encode}_{evaluation}_result.csv'),
                  index=False)
    print('Result has been saved to result_hpo.csv.')
    
    
    pred_ens = opt_hpo.predict(test_data_node, ens=True)
    ...
    result_ens.to_csv(os.path.join(data_dir,
                               f'SMAC{estimator_id}{x_encode}{label_encode}_{evaluation}_result_ens.csv'),
                  index=False)
