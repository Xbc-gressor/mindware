...
if __name__ == '__main__':
    ...
    parser.add_argument('--kaggle_id', type=str, default="house-prices-advanced-regression-techniques")
    ...
    parser.add_argument('--metric', type=str, default='msle', help='metric')
    ...
    train_data_node = dm.load_train_csv(os.path.join(kaggle_id, 'train.csv'), drop_index=[0], label_col=-1)
    train_data_node = dm.preprocess_fit(train_data_node, task_type)

    test_data_node = dm.load_test_csv(os.path.join(kaggle_id, 'test.csv'))
    test_data_node = dm.preprocess_transform(test_data_node)

    id_data = pd.read_csv(os.path.join(kaggle_id, 'test.csv'))['Id']
