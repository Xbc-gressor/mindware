...
include_algorithms = [
    'adaboost', 'extra_trees', 'random_forest', 'lightgbm', 'xgboost'
]
...
if __name__ == '__main__':
    ...
    parser.add_argument('--kaggle_id', type=str, default="playground-series-s5e5")
    ...
    parser.add_argument('--time_limit', type=int, default=43200, help='time limit')
