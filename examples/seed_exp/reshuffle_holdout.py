...
if '__main__' == __name__:
    ...
    parser.add_argument('--late_reshuffle', action='store_true', default=False)
    ...
    for dataset in chosen_datasets:
        ...
        if args.Opt in ['cash', 'cashfe']:
            opt = OPT(
                ...
                reshuffle = args.reshuffle, late_reshuffle = args.late_reshuffle, resampling_params = {'folds':FOLDS, 'min_iter':MIN_ITER}
            )
        ...
        with open(args.output_file, 'a+') as f:
            f.write(f'CLS: {args.Opt}-{args.optimizer}, estimator:{estimator_id}, {formatted_start_time}, {args.estimator_id}, reshuffle:{args.reshuffle}, late_reshuffle:{args.late_reshuffle}, {args.time_limit}, {dataset}: {perf}, {ens_perf}\n')
