...
if __name__ == '__main__':
    ...
    result_hpo.to_csv(os.path.join(data_dir, f'hpo{estimator_id}{x_encode_str}_{evaluation}_{optimizer}{time_limit}_{ensemble_method}{ensemble_size}_result_hpo.csv'), index=False)
