...
class CatboostClassifier(BaseClassificationModel):
    def __init__(self, iterations, learning_rate, depth, l2_leaf_reg, 
    ...
    def get_hyperparameter_search_space(dataset_properties=None, optimizer='smac', **kwargs):
        ...
        l2_leaf_reg = UniformFloatHyperparameter(
            name="l2_leaf_reg", lower=1.0, upper=10.0, default_value=3.0, log=False)
        # loss_function = CategoricalHyperparameter(
            # name="loss_function", choices=["Logloss", "CrossEntropy"], default_value="Logloss")
